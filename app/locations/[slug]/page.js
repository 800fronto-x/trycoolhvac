...
export async function generateMetadata({ params }) {
  ...
  const description = `Professional heating and air conditioning services in ${loc.city}, ${loc.state}. AC repair, furnace repair, and HVAC installation. Call 202-455-0020 for same-day service in ${loc.county}.`;
