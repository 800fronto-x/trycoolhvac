      ...
      <div className={`bg-white sticky top-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-3">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a href="tel:2024550020" className="text-navy-900 font-black text-lg hover:text-blue-800 transition flex items-center space-x-1.5">
        ...
        <div className={`lg:hidden overflow-hidden transition-all duration-300 ease-in-out ${
          ...
          <div className="bg-white border-t px-6 py-4 space-y-1">
            ...
            <div className="border-t pt-3 mt-2 space-y-3">
              <a href="tel:2024550020" className="flex items-center space-x-2 text-red-600 font-bold text-lg py-2 px-3">
